    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_path', models.ImageField(blank=True, null=True, upload_to='menu_item_images/')),
            ],
        ),
        migrations.CreateModel(
            name='Restaurant',
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True, null=True)),
                ('logo_path', models.ImageField(blank=True, null=True, upload_to='restaurant_logos/')),
            ],
        ),
        migrations.CreateModel(
            name='User',
